class ImageInput
    ...
    input_wrapping do
      ...
      unless @object.new_record? or @object.send( @method ).blank?
        ...
        output << "<a class=\"modal\" href=\"#{ Rails.application.routes.url_helpers.send( "crop_admin_#{@object.class.name.underscore}_path", @object, { image: method, style: @options[:style] } ) }\">".html_safe if cropable
